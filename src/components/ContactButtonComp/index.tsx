...
export function ContactButtonComp ( {imgIconContactPath, hrefLink}:ContactButtonCompProps ) {
    return (
        <div>
            <a href={hrefLink} target='_blank' rel="noopener noreferrer" className={styleContactButton}>
                <img
