      ...
      <div className="max-w-6xl mx-auto px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-14">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-8 h-8 bg-neutral-900 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <path d="M3 5h5l3 4-3 4H3l3-4-3-4z" fill="white" opacity="0.9" />
                  <path d="M9 5h6v3l-3 1 3 1v3H9l3-4-3-4z" fill="white" opacity="0.5" />
                </svg>
              </div>
            ...
            {/* Tagline */}
            <p className="text-sm text-neutral-500 leading-relaxed mb-6 max-w-[240px]">
              Transformando negócios através de automação inteligente. Onde criatividade humana encontra precisão das máquinas.
            </p>
            ...
            <div className="flex items-center gap-2">
              <a
                href="#"
                aria-label="LinkedIn"
                className="w-8 h-8 rounded-lg bg-neutral-200 flex items-center justify-center text-neutral-500 hover:bg-neutral-900 hover:text-white transition-all duration-200"
              >
          ...
          {/* Services */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-neutral-900 mb-5">
              Serviços
            </h4>
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500 leading-relaxed mb-4">
              Receba os últimos insights sobre IA e novidades da agência direto no seu email.
            </p>
            <form onSubmit={handleSubmit} className="flex flex-col gap-2">
              <div className="flex items-center bg-white border border-neutral-200 rounded-xl overflow-hidden focus-within:border-neutral-900 focus-within:ring-2 focus-within:ring-neutral-900/10 transition-all duration-200">
                ...
                <button
                  ...
                  className="m-1 w-9 h-9 bg-neutral-900 hover:bg-neutral-700 text-white rounded-lg flex items-center justify-center transition-all duration-200 hover:translate-x-0.5 flex-shrink-0"
                >
                  {submitted ? (
