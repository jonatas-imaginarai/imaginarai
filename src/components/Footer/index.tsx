          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-2">
              <a
                href="#"
                aria-label="LinkedIn"
                className="w-8 h-8 rounded-lg bg-neutral-200 flex items-center justify-center text-neutral-500 hover:bg-zinc-700 hover:text-white transition-all duration-200"
              >
